...
| [**08**](lectures/mobile/lecture-08) | Visualização de dados por meio de listas. | [22/9](lectures/mobile/lecture-0) |
| **09**. | Revisão conjunta dos projetos de desenvolvimento. Entrega do _design_ do projeto de desenvolvimento (**T1**). Apresentação das Pesquisas (**P1**). | 29/9 |
